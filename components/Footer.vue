          ...
          <div class="footer-menu">
            <ul class="ff-sans-r">
              <li :class="{ active: $route.name === 'requisitos' }">
                <NuxtLink to="/requisitos">Requisitos</NuxtLink>
              </li>
              <li :class="{ active: $route.name === 'prepare-su-audicion' }">
                <NuxtLink to="/prepare-su-audicion"
                  >Prepare su Audición</NuxtLink
                >
              </li>
              <li :class="{ active: $route.name === 'repertorios' }">
                <NuxtLink to="/repertorios">Repertorios</NuxtLink>
              </li>
              <li :class="{ active: $route.name === 'jurados' }">
                <NuxtLink to="/jurados">Jurados</NuxtLink>
              </li>
            </ul>
          </div>
          <div class="footer-menu">
            <ul class="ff-sans-r">
              <li :class="{ active: $route.name === 'seleccionados' }">
                <NuxtLink to="/seleccionados">Seleccionados</NuxtLink>
              </li>
              <li :class="{ active: $route.name === 'faqs' }">
                <NuxtLink to="/faqs">FAQ</NuxtLink>
              </li>
              <li>
                <a target="_blank" href="/Terminos_y_Condiciones_Audiciones_Temp_2022-VF_2021_02_24.pdf"
